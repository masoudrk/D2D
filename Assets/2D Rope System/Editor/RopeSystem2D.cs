...
public class RopeSystem2D : EditorWindow{
	...
	void OnGUI ()
    {
        ...
        nodeWeight = EditorGUILayout.FloatField("Node Weight", nodeWeight);
        GUILayout.Space(5);
...
//		fontStyle.normal.textColor = Color.green;
	...
	void Create()
	{
		...
		rope.CreateRope (chainsHolder, chainObject , nodeWeight, pointA, pointB, lockFirstChain, lockLastChain, connectToA, connectToB, hideEndChains, useLineRenderer, ropeMat, ropeWidth);
	}
}