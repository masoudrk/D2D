...
public class Rope2D
{
	...
	public void CreateRope(GameObject objectsHolder, GameObject chainObject, float nodeWeight, Transform pointA, Transform pointB, bool lockFirstChain, bool lockLastChain, bool connectToA, bool connectToB, bool hideEndObjects, bool useLineRenderer, Material ropeMat, float ropeWidth)
	{
		...
		while (!connected)
		{
			...
			if (!tempChain)//if this is first chain
			{
				...
				if(connectToA)
				{
                    ...
                    pointA.GetComponent<Rigidbody2D>().mass = nodeWeight;
                }
